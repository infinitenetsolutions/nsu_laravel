<?php include "include/header.php";?>
  ...
  <div class="main-content">
    ...
    <!-- Section Vice Chancellors Message -->
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Vice Chancellors Message <span class="text-theme-colored2">Learnpro</span></h3>
            ...
            <div class="col-md-4">
              ...
              <div class="double-line-bottom-theme-colored-2"></div>
              <div class="box-hover-effect Vice Chancellors Message-video">
                <div class="effect-wrapper">
                  <div class="thumb">
                    <img class="img-fullwidth" src="images/Vice Chancellors Message/video-thumb.jpg" alt="project">
                  </div>
