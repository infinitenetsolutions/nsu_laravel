...
" alt=""></a>
  ...
  <div class="header-nav">
      <div class="header-nav-wrapper navbar-scrolltofixed" style="z-index: 999; position: static; top: auto;background:#000;">
        <div class="container">
          <nav id="menuzord" class="menuzord default menuzord-responsive"><a href="javascript:void(0)" class="showhide" style="display: none;"><em></em><em></em><em></em></a>
            <ul class="menuzord-menu menuzord-indented scrollable" style="max-height: 400px;">
              ...
              <li><a href="#">Features <span class="label label-danger">New</span><span class="indicator"><i class="fa fa-angle-down"></i></span></a>
                <ul class="dropdown none" style="right: auto; display: none;">
                  ...
                  <li><a href="#">Header Modern <span class="label label-danger">New</span><span class="indicator"><i class="fa fa-angle-right"></i></span></a>
                    <ul class="dropdown" style="display: none;">
                  ...
                  <li><a href="#">Header Floating <span class="label label-danger">New</span><span class="indicator"><i class="fa fa-angle-right"></i></span></a>
                    <ul class="dropdown" style="">
                  ...
                  <li><a href="#">Paypal Form <span class="label label-danger">New</span><span class="indicator"><i class="fa fa-angle-right"></i></span></a>
                    <ul class="dropdown" style="">
              ...
              <li><a href="#">Pages<span class="indicator"><i class="fa fa-angle-down"></i></span></a>
                <ul class="dropdown" style="right: auto; display: none;">
                  ...
                  <li><a href="#home">Teachers<span class="indicator"><i class="fa fa-angle-right"></i></span></a>
                    <ul class="dropdown" style="">
                  ...
                  <li><a href="#">Job<span class="indicator"><i class="fa fa-angle-right"></i></span></a>
                    <ul class="dropdown" style="">
              ...
              <li><a href="javascript:void(0)">Mega Menu <span class="label label-danger">New</span><span class="indicator"><i class="fa fa-angle-down"></i></span></a>
              ...
              <li><a href="javascript:void(0)">Shortcodes <span class="label label-danger">New</span><span class="indicator"><i class="fa fa-angle-down"></i></span></a>
      ...
      </div><div style="display: none; width: 1349px; height: 70.5625px; float: none;"></div>
    </div>
    </div>
  </header>
