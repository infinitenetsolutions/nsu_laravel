<?php include "include/header.php";?>
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Registrars Message</h2>
    ...
    <!-- Section Registrars Message -->
    <section>
      <div class="container pt-70 pb-40">
        <div class="section-title">
          <div class="row">
            <div class="col-md-8">
              <h3 class="text-uppercase mt-0">Registrars Message <span class="text-theme-colored2">Learnpro</span></h3>
            ...
            <div class="col-md-4">
              ...
              <div class="double-line-bottom-theme-colored-2"></div>
              <div class="box-hover-effect Registrars Message-video">
                <div class="effect-wrapper">
                  <div class="thumb">
                    <img class="img-fullwidth" src="images/Registrars Message/video-thumb.jpg" alt="project">
                  </div>
