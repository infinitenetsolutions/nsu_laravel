...
<!-- Page Title -->
<title>Netaji Subhas University | Image Gallery | NSU</title>
          ...
          <div class="row">
              ...
              <div class="gallery-isotope default-animation-effect grid-5 masonry gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item wide">
                  <div class="thumb">
                    <img class="img-fullwidth" src="http://placehold.it/800x600" alt="project">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="http://placehold.it/800x600"><i class="fa fa-plus"></i></a>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    ...
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="http://placehold.it/400x300"><i class="fa fa-plus"></i></a>
                          <a href="#"><i class="fa fa-link"></i></a>
                        </div>
                      </div>
                    </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img class="img-fullwidth" src="http://placehold.it/400x600" alt="project">
                    <div class="overlay-shade"></div>
                    <div class="text-holder">
                      <div class="title text-center">Sample Title</div>
                    </div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a data-lightbox="image" href="http://placehold.it/400x600"><i class="fa fa-plus"></i></a>
                          <a href="#"><i class="fa fa-link"></i></a>
                        </div>
                      </div>
                    </div>
