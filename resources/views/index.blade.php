<x-layout>
    ...
    <div class="main-content">
                            ...
                            <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;"
                                ...
                                <ul>
                                    ...
                                    <li data-index="rs-1" data-transition="fade" data-slotamount="default"
                                        ...
                                        data-thumb="https://nsuniv.ac.in/assets/images/upload/slider/new_sliders/nsu107.jpg" data-rotate="0" data-fstransition="fade"
                                        data-saveperformance="off" data-title="Web Show" data-description="">
                                        <!-- MAIN IMAGE -->
                                        <img src="https://nsuniv.ac.in/assets/images/upload/slider/new_sliders/nsu107.jpg"
                                        ...
                                        <div style="float: left !importent">
                                            <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700"
                                                ...
                                                data-mask_out="x:0;y:0;s:inherit;e:inherit;" data-start="600"
                                                data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                                style="z-index: 5; white-space: nowrap; font-weight:700;">Best <span
                                            ...
                                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                                ...
                                                data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                                style="z-index: 5; white-space: nowrap;">We provides always our best
                                                educational services for our all students <br> and always try to achieve
                                                our students trust and satisfaction
                                            </div>
                                            <!-- LAYER NR. 4 -->
                                            <div class="tp-caption rs-parallaxlevel-0" id="slide-1-layer-4"
                                                data-x="['center','center','center','center']"
                                                data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']"
                                                data-voffset="['350','330','290','290']" data-width="none"
                                                data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;"
                                                data-transform_hover="o:1;rX:0;rY:0;rZ:0;z:0;s:300;e:Power1.easeInOut;"
                                                data-transform_in="y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;s:1500;e:Power3.easeInOut;"
                                                data-transform_out="auto:auto;s:1000;e:Power3.easeInOut;"
                                                data-mask_in="x:0px;y:0px;" data-mask_out="x:0;y:0;" data-start="800"
                                                data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                                data-responsive="off"
                                    ...
                                    <li data-index="rs-2" data-transition="fade" data-slotamount="default"
                                        ...
                                        data-saveperformance="off" data-title="Web Show" data-description="">
                                        <!-- MAIN IMAGE -->
                                        <img src="https://nsuniv.ac.in/assets/images/upload/slider/new_sliders/nsu102.jpg"
                                            alt="" data-bgposition="center center" data-bgfit="cover"
                                            data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                                            data-no-retina>
                                        <!-- LAYERS -->
                                        ...
                                        <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700"
                                            ...
                                            data-mask_out="x:0;y:0;s:inherit;e:inherit;" data-start="600"
                                            data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                            style="z-index: 5; white-space: nowrap; font-weight:700;">Welcome To<span
                                                class="text-theme-colored2"> Learpro</span>
                                        </div>
                                        <!-- LAYER NR. 3 -->
                                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                            id="slide-2-layer-3" data-x="['center','center','center','center']"
                                            data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']"
                                            data-voffset="['275','260','220','220']" data-fontsize="['16','16',18',16']"
                                            data-lineheight="['24','24','24','24']"
                                            data-fontweight="['400','400','400','400']"
                                            data-textalign="['center','center','center','center']"
                                            data-width="['800','650','600','460']" data-height="none"
                                            ...
                                            data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                            style="z-index: 5; white-space: nowrap; ">We provides always our best
                                            educational services for our all students <br> and always try to achieve our
                                    ...
                                    <li data-index="rs-3" data-transition="fade" data-slotamount="default"
                                        data-easein="default" data-easeout="default" data-masterspeed="default"
                                        data-thumb="images/bg/bg3.jpg" data-rotate="0" data-fstransition="fade"
                                        data-saveperformance="off" data-title="Web Show" data-description="">
                                        <!-- MAIN IMAGE -->
                                        <img src="https://nsuniv.ac.in/assets/images/upload/slider/new_sliders/nsu109.jpg"
                                            alt="" data-bgposition="center center" data-bgfit="cover"
                                            data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg"
                                            data-no-retina>
                                        <!-- LAYERS -->
                                        ...
                                        <div class="tp-caption tp-resizeme rs-parallaxlevel-0 text-white text-uppercase font-roboto-slab font-weight-700"
                                            ...
                                            data-mask_out="x:0;y:0;s:inherit;e:inherit;" data-start="600"
                                            data-splitin="none" data-splitout="none" data-responsive_offset="on"
                                            style="z-index: 5; white-space: nowrap; font-weight:700;">Leading<span
                                                class="text-theme-colored2"> University</span>
                                        </div>
                                        <!-- LAYER NR. 3 -->
                                        <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                        ...
                        <div
                            ...
                            <div class="sm-height-auto" data-bg-color="#5D9CEC">
                                <div class="features-box-colored text-center p-15 pt-30 pb-20">
                                    ...
                                    <h4 class="text-uppercase font-weight-600 mt-0"><a href="page-donate.html"
                                            class="text-white">Popular Courses</a></h4>
                                    <p class="text-white">Lorem ipsum dolor sit amet, consectetur adpisici elit.
                                        Obcaec atdistinc tio quaerat iusto, accusa ntumeos nsect eturpers piciatis
                                        minima tempore!</p>
                        ...
                        <div
                            ...
                            <div class="sm-height-auto" data-bg-color="#EF5861">
                                <div class="features-box-colored text-center p-15 pt-30 pb-20">
                                    ...
                                    <h4 class="text-uppercase font-weight-600 mt-0"><a href="page-donate.html"
                                            class="text-white">Modern Library</a></h4>
                                    <p class="text-white">Lorem ipsum dolor sit amet, consectetur adpisici elit.
                                        Obcaec atdistinc tio quaerat iusto, accusa ntumeos nsect eturpers piciatis
                                        minima tempore!</p>
                                    <div class="shadow-icon"><i class="pe-7s-mail-open"></i></div>
                        ...
                        <div
                            ...
                            <div class="sm-height-auto" data-bg-color="#E79800">
                                <div class="features-box-colored text-center p-15 pt-30 pb-20">
                                    ...
                                    <h4 class="text-uppercase font-weight-600 mt-0"><a href="page-donate.html"
                                            class="text-white">Qualified Teachers</a></h4>
                                    <p class="text-white">Lorem ipsum dolor sit amet, consectetur adpisici elit.
                                        Obcaec atdistinc tio quaerat iusto, accusa ntumeos nsect eturpers piciatis
                                        minima tempore!</p>
                                    <div class="shadow-icon"><i class="pe-7s-mail-open"></i></div>
                        ...
                        <div
                            ...
                            <div class="sm-height-auto" data-bg-color="#43B14B">
                                <div class="features-box-colored text-center p-15 pt-30 pb-20">
                                    ...
                                    <h4 class="text-uppercase font-weight-600 mt-0"><a href="page-donate.html"
                                            class="text-white">Certification</a></h4>
                                    <p class="text-white">Lorem ipsum dolor sit amet, consectetur adpisici elit.
                                        Obcaec atdistinc tio quaerat iusto, accusa ntumeos nsect eturpers piciatis
                                        minima tempore!</p>
                                    <div class="shadow-icon"><i class="pe-7s-mail-open"></i></div>
        ...
        <section class="parallax layer-overlay overlay-theme-colored-9" data-bg-img="https://nsuniv.ac.in/assets/images/upload/slider/new_sliders/nsu107.jpg"
                ...
                <div class="section-title">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="double-line-bottom-theme-colored-2"></div>
                            <p class="font-16 mt-20">Lorem ipsum dolor sit amet, consecte turadipie sicing elit. Quas
                                voluptatem maiores eaques Quasvolu ptatem maiores</p>
                ...
                <div class="section-title">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-uppercase title">Popular <span class="text-theme-colored2">Courses</span>
                            </h2>
                        ...
                        <div class="item">
                            <div class="course-single-item bg-white border-1px clearfix mb-30">
                                ...
                                <div class="course-details clearfix p-20 pt-15">
                                    ...
                                    <p class="course-description mt-20">Lorem ipsum dolor sit amet, consec teturadipsi
                                        cing elit. Nobis commodi esse aliquam eligend reprehenderit, numquam a odio.</p>
        ...
        <section id="team">
            <div class="container pb-40">
                <div class="section-title">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-uppercase title">Qualified <span class="text-theme-colored2">Teachers</span>
                            </h2>
                            <div class="double-line-bottom-centered-theme-colored-2 mt-20"></div>
                            ...
                            <div class="team-members maxwidth400 mb-30">
                                ...
                                <div class="team-bottom-part bg-silver-deep p-15 pb-0">
                                    <h4
                                        ...
                                        Mr. M. M. Singh <span class="text-gray font-13 ml-5">- Chancellor</span></h4>
                                    <p class="font-13 mt-10 mb-10">NETAJI SUBHAS UNIVERSITY, a highly progressive and
                                        enterprising university pledged to provide quality education with great emphasis
                                        on traditional values. Quality in education is what makes learning a pleasure.
                                    </p>
                        ...
                        <div class="col-md-3">
                            <div class="team-members maxwidth400 mb-30">
                                ...
                                <div class="team-bottom-part bg-silver-deep p-15 pb-0">
                                    <h4
                                        class="text-uppercase font-raleway text-theme-colored title-border font-weight-600 line-bottom-center m-0">
                                        Prof. (Dr). GOURANGA CHARAN NANDA <span class="text-gray font-13 ml-5">- Vice
                                            Chancellor</span></h4>
                                    <p class="font-13 mt-10 mb-10">Prof. Gouranga Charan Nanda, a Ph.D in Educaation
                                        from Utkal Unversity has had a professional career in Teaching, Research and
                                        Administration spanning over a period of 42 years since 1980. He worked for both
                                        school and college wing, teaching students from Higher Secondary to
                                        Post-graduate classes, elementary level teacher education to secondary level
                                        teacher education students as well as M Phil and Ph.D . students in Education.
                                    </p>
                                    <ul class="styled-icons icon-theme-colored2">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            ...
                            <div class="team-members maxwidth400 mb-30">
                                ...
                                <div class="team-bottom-part bg-silver-deep p-15 pb-0">
                                    ...
                                    <p class="font-13 mt-10 mb-10">Prof. Gouranga Charan Nanda, a Ph.D in Educaation
                                        ...
                                        school and college wing, teaching students from Higher Secondary to
                                        Post-graduate classes, elementary level teacher education to secondary level
                                        teacher education students as well as M Phil and Ph.D </p>
                                    <ul class="styled-icons icon-theme-colored2">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-instagram"></i></a></li>
                        ...
                        <div class="col-md-3">
                            <div class="team-members maxwidth400 mb-30">
                                ...
                                <div class="team-bottom-part bg-silver-deep p-15 pb-0">
                                    <h4
                                        class="text-uppercase font-raleway text-theme-colored title-border font-weight-600 line-bottom-center m-0">
                                        Mr. Nagendra Singh <span class="text-gray font-13 ml-5">- Registrar</span></h4>
                                    <p class="font-13 mt-10 mb-10">I wish to thank you for showing interest in NETAJI
                                        SUBHAS UNIVERSITY. We have been providing quality education for over than last
                                        15 years.

                                        At NETAJI SUBHAS UNIVERSITY, students are expected to have an enriching and
                                        life-turning experience which will enable them to reach new heights in their
                                        professional life. We foster sharpening of skills and enhancement of knowledge
                                        base in our students through various extra-curricular, co-curricular and
                                        curricular activities through faculty who not only keep themselves at par with
                                        the current developments but also contribute to the expansion of the body of
                                        knowledge in their field of expertise.</p>
                                    <ul class="styled-icons icon-theme-colored2">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-instagram"></i></a></li>
        ...
        <section class="parallax Divider layer-overlay overlay-theme-colored-9" data-bg-img="images/bg/bg7.jpg"
            data-parallax-ratio="0.4">
            <div class="container pt-70 pb-30">
                <div class="section-title">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="text-uppercase text-white title">What <span class="text-theme-colored2">People
                                </span>Say</h2>
                            <div class="double-line-bottom-centered-theme-colored-2 mt-20"></div>
                            ...
                            <div class="item">
                                <div class="testimonial pt-10">
                                    <div class="thumb pull-left mb-0 mr-0">
                                        <img class="img-thumbnail img-circle" alt="" src="images/testimonials/43.jpg"
                                            style="width:100px">
                                    </div>
                                    <div class="testimonial-content">
                                        <h4 class="text-white font-weight-300 mt-0">As a student of NSU, I not only got
                                            the chance to showcase my potential in academics but also the other
                                            co-curricular activity which are an active part of the learning enviroment.
                                            This was perfectly aided through the cooperation of the excellent faculty
                                            and peer group.</h4>
                                        <h5 class="text-theme-colored2 mt-10 font-16 mb-0">Ranjana Ghosh MBA (2017-19)
                                        </h5>
                                                ...
                                                <div class="media-body pl-0">
                                                    <div class="event-content pull-left flip">
                                                        <h4
                                                            ...
                                                            <a href="blog-single-left-sidebar.html">Post title here</a>
                                                        </h4>
                                                        <ul class="list-inline">
                                                            <li><i class="fa fa-user-o mr-5 text-theme-colored2"></i>By
                                                                Author</li>
                                                            <li><i
                                                                    class="fa fa-thumbs-o-up mr-5 text-theme-colored2"></i>Likes
                                                            </li>
                                                            <li><i class="fa fa-share-alt mr-5 text-theme-colored2"></i>
                                                                895 Likes</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="mt-5">Lorem ipsum dolor sit amet, consectetur adipisi
                                                cing elit. Molestias eius illum libero dolor nobis deleniti</p>
                                                    ...
                                                    <div class="form-group mb-20">
                                                        <div class="styled-select">
                                                            <select id="person_select" name="person_select"
                                                                ...
                                                                <option value="2 Person">Computer Science engineering
                                                                </option>
                            ...
                            <form id="mailchimp-subscription-form-footer" class="newsletter-form mt-20 pt-5">
                                <div class="input-group">
                                    <input value="" name="EMAIL" placeholder="Your Email"
                                        ...
                                        style="height: 45px;" type="email">
                                    <span class="input-group-btn">
                                        <button data-height="45px"
                                            class="btn btn-theme-colored text-white btn-xs m-0 font-14" type="submit"
                                            style="height: 45px;">Subscribe</button>
                                    </span>
                                </div>
                            </form>
