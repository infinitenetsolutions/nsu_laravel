                            ...
                            <div class="col-md-3">
                                <div class="team-members maxwidth400 mb-30">
                                    <div class="team-thumb">
                                        <img height="190px" src="{{ $url.'teacher/'.$university_head->image_name }}"
                                        ...
                                        <article class="post clearfix mb-30">
                                            <div class="entry-header">
                                                <div class="post-thumb thumb">
                                                    <img height="500px" src="{{ $url.'latestnews/'.$latest->images }}"
                                            ...
                                            <div class="entry-content bg-white p-15">
                                                ...
                                                <a class="btn btn-default btn-flat font-12 mt-10 ml-5"
                                                    href="{{ route('news',['id'=>$latest->id]) }}"> View Details</a>
                                            </div>
                                        </article>
                                    </div>
                                    @endforeach
