<x-layout>
    ...
    <div class="main-content">
        ...
        data-bg-img="{{$url.'placement/'.$data->image_name}}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box-hover-effect about-video">
                                <div class="effect-wrapper">
                                    <div class="thumb">
                                        <img class="img-fullwidth" src="{{$url.'placement/'.$data->image_name}}"
                                            alt="project">
                                    </div>
                                ...
                                <hr>
                                <div class="thumb">
                                    <img class="img-fullwidth" src="{{$url.'placement/'.$data->image_name1}}"
                                        alt="project">
                                </div>
                            </div>
                                ...
                                <div class="widget border-1px bg-silver-deep p-15 side-bars">
                                    ...
                                    <div class="categories">
                                        <ul class="list-border">
                                            ...
                                            <li><a href="{{ route('placement',$quick->title) }}"> {{ $quick->sub_title }}
                                                </a></li>
                                            @endforeach
