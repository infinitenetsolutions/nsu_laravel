        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="widget dark">
                    <div style="text-align:center;">
                        ...
                        <img src="{{ asset('images/flogo.png') }} " class="img-fluid mb-3"
                            alt="Netaji Subhas University" style="filter: drop-shadow(9px 9px 9px #000);">
                    </div>
                        ...
                        @foreach ($programs as $program)
                            <li class=" text-capitalize"> <a
                                    href="{{ route('program', strtolower(str_replace(' ', '-', $program->program))) }}"><b>
                                        {{ ucfirst(strtolower($program->program)) }}
                                </a> </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    <div class="widget dark">
                        <ul class="angle-double-right list-border">
                            <h4 class="widget-title line-bottom-theme-colored-2"> Education Loan</h4>
