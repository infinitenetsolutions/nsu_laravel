<x-layout>
    ...
    <div class="main-content">
        ...
        data-bg-img="{{$url.'infrastructure/'.$data->image_name}}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="box-hover-effect about-video">
                                <div class="effect-wrapper">
                                    <div class="thumb">
                                        <img class="img-fullwidth" src="{{$url.'infrastructure/'.$data->image_name}}"
                                            alt="project">
                                    </div>
                                ...
                                <div class="widget border-1px bg-silver-deep p-15 side-bars">
                                    ...
                                    <div class="categories">
                                        <ul class="list-border">
                                            ...
                                            <li><a href="{{ route('infrastructure',$quick->title) }}"> {{ $quick->sub_title }}
                                                </a></li>
                                            @endforeach
