                                    ...
                                    <div class="panel-heading">
                                        <div class="panel-title"> <a class="collapsed" data-toggle="collapse"
                                                href="#toggle{{ $transport->id }}" aria-expanded="false"><span
                                                    class="open-sub"></span> <big> {{ $transport->name.' - '.$transport->bus_no  }} (Route - {{ $transport->from .' TO '. $transport->to .' VIA '. $transport->via }} ( for - @if($transport->type!='none') {{  $transport->type  }} @else  @endif ))</big> </a>
                                        </div>
                                    </div>
