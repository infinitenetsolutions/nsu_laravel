      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-4">
          <div class="widget dark">
            ...
            <li class="m-0 pl-10 pr-10"> <i class="fa fa-map-marker text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">Pokhari , Near Bhilai Pahadi ,
Jamshedpur , Jharkhand </a> </li><br>
            
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">0657-223-3022, 9386-817-857</a> </li><br>
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">info@nsuniv.ac.in</a> </li><br>
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-colored2 mr-5"></i> <a class="text-gray" href="#">https://nsuniv.ac.in/</a> </li>
            </ul>            
