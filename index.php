          ...
          <div class="team-members">
            <div class="col-md-3">
              <div class="team-members maxwidth400 mb-30">
                ...
                <div class="team-bottom-part bg-silver-deep p-15 pb-0">
                  <h4 class="text-uppercase font-raleway text-theme-colored title-border font-weight-600 line-bottom-center m-0"> Mr. M. M. Singh <span class="text-gray font-13 ml-5">- Chancellor</span></h4>                  
                  <p class="font-13 mt-10 mb-10">NETAJI SUBHAS UNIVERSITY, a highly progressive and enterprising university pledged to provide quality education with great emphasis on traditional values. Quality in education is what makes learning a pleasure.</p>
            ...
            <div class="col-md-3">
              <div class="team-members maxwidth400 mb-30">
                ...
                <div class="team-bottom-part bg-silver-deep p-15 pb-0">
                  <h4 class="text-uppercase font-raleway text-theme-colored title-border font-weight-600 line-bottom-center m-0">Prof. (Dr). GOURANGA CHARAN NANDA <span class="text-gray font-13 ml-5">- Vice Chancellor</span></h4>                  
                  <p class="font-13 mt-10 mb-10">Prof. Gouranga Charan Nanda, a Ph.D in Educaation from Utkal Unversity has had a professional career in Teaching, Research and Administration spanning over a period of 42 years since 1980. He worked for both school and college wing, teaching students from Higher Secondary to Post-graduate classes, elementary level teacher education to secondary level teacher education students as well as M Phil and Ph.D . students in Education.</p>
                  <ul class="styled-icons icon-theme-colored2">
                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="#"><i class="fa fa-instagram"></i></a></li>
            ...
            <div class="col-md-3">
              <div class="team-members maxwidth400 mb-30">
                ...
                <div class="team-bottom-part bg-silver-deep p-15 pb-0">
                  <h4 class="text-uppercase font-raleway text-theme-colored title-border font-weight-600 line-bottom-center m-0"> Dr. ACHARYA RISHI RAJAN <span class="text-gray font-13 ml-5">- Pro Vice Chancellor</span></h4>                  
                  <p class="font-13 mt-10 mb-10">Prof. Gouranga Charan Nanda, a Ph.D in Educaation from Utkal Unversity has had a professional career in Teaching, Research and Administration spanning over a period of 42 years since 1980. He worked for both school and college wing, teaching students from Higher Secondary to Post-graduate classes, elementary level teacher education to secondary level teacher education students as well as M Phil and Ph.D </p>
                  <ul class="styled-icons icon-theme-colored2">
                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="#"><i class="fa fa-instagram"></i></a></li>
            ...
            <div class="col-md-3">
              <div class="team-members maxwidth400 mb-30">
                ...
                <div class="team-bottom-part bg-silver-deep p-15 pb-0">
                  <h4 class="text-uppercase font-raleway text-theme-colored title-border font-weight-600 line-bottom-center m-0"> Mr. Nagendra Singh <span class="text-gray font-13 ml-5">- Registrar</span></h4>                  
                  <p class="font-13 mt-10 mb-10">I wish to thank you for showing interest in NETAJI SUBHAS UNIVERSITY. We have been providing quality education for over than last 15 years.

At NETAJI SUBHAS UNIVERSITY, students are expected to have an enriching and life-turning experience which will enable them to reach new heights in their professional life. We foster sharpening of skills and enhancement of knowledge base in our students through various extra-curricular, co-curricular and curricular activities through faculty who not only keep themselves at par with the current developments but also contribute to the expansion of the body of knowledge in their field of expertise.</p>
                  <ul class="styled-icons icon-theme-colored2">
                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="#"><i class="fa fa-instagram"></i></a></li>
              ...
              <div class="item">
                <div class="testimonial pt-10">
                  <div class="thumb pull-left mb-0 mr-0">
                    <img class="img-thumbnail img-circle" alt="" src="images/testimonials/43.jpg" style="width:100px">
                  </div>
                  <div class="testimonial-content">
                    <h4 class="text-white font-weight-300 mt-0">As a student of NSU, I not only got the chance to showcase my potential in academics but also the other co-curricular activity which are an active part of the learning enviroment. This was perfectly aided through the cooperation of the excellent faculty and peer group.</h4>
                    <h5 class="text-theme-colored2 mt-10 font-16 mb-0">Ranjana Ghosh MBA (2017-19)</h5>
        ...
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <h3 class="title-pattern mt-0"><span class="text-white">Request <span class="text-theme-colored2" style="color:#000!important;">Information</span></span></h3>
          ...
          <div class="col-md-10 col-md-offset-1">
            <div class="subscribe-newsletter">
              <div class="newsletter-form">
                ...
                <form id="mailchimp-subscription-form-footer" class="newsletter-form mt-10" novalidate="true">
