  ...
  <div class="main-content">
    ...
    <section>
      <div class="container">
        <div class="row">
        <div class="col-md-6">              
              <h2 class="text-uppercase line-bottom-theme-colored-2 line-height-1 mt-0 mt-sm-30"><i class="fa fa-question-circle-o mr-10"></i>Current  <span class="text-theme-colored2">Openings</span></h2>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group mb-10">
                      ...
                      <input name="form_appontment_time" class="form-control required time-picker" type="file" placeholder="Appoinment Time" aria-required="true">
                    </div>
                  </div>
                </div>
                <div class="form-group mb-10">
